                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Please enter your credential email and password for login to our application",
                            ...
                            Container(
                              ...
                              child: Form(
                                ...
                                child: TextFormField(
                                  ...
                                  obscureText: istap == false ? istap : true,
                                  onFieldSubmitted: (value) {
                                    setState(() {
                                      txtpassword.text = value;

                                      if (formkeypassword.currentState!
                                          .validate()) {
                      ...
                      Container(
                        margin: EdgeInsets.only(
                            top: 1, bottom: 15, left: 15, right: 15),
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
            "Sorry, an email has already registered, please try another one",
            textAlign: TextAlign.center,
            style: TextStyle(
                fontSize: 12.8,
