...
class _MyNavScreenState extends State<MyNavScreen> {
  ...
  var title = ["Home", "Discover", "Cart", "Order", 'Profile'];
  var icon = [
  ...
  void CheckAuthorize() async {
    ...
    BlocProvider.of<AddressBloc>(context)
        .add(FetchAddress(userid: prefs!.getInt("userid")));
  }
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: GNav(
          ...
          gap:
              8, // the tab button gap between icon and text/ unselected icon color/ selected icon and text color
          ...
          textStyle: TextStyle(color: Colors.white), // navigation
          tabs: List.generate(
            iconlogo.length,
            (index) {
              return GButton(
