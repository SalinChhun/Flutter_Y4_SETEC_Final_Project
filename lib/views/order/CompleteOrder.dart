              ...
              child: BlocConsumer<OrderBloc, OrderState>(
                ...
                builder: (context, state) {
                  if (state is OrderDetailSuccess) {
                    ...
                    var urlimg =
                        "https://django-ecomm-6e6490200ee9.herokuapp.com";
                      ...
                      children: [
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            Color colorcode =
                                HexColor(cart![index].colorselection!.code!);

                            for (int i = 0;
                                i < state.orderDetail!.products!.length;
                                i++)
                              subqty += state
                                  .orderDetail!.products![i].quantity!
                                  .toInt();
                            return Container(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '\ Total: \$ ${(cart![index].colorselection!.price! * (cart![index].quantity!)).toStringAsFixed(2)}',
                                          style: TextStyle(
                                              fontSize: 11.5,
                                    ...
                                    Container(
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '\$ ${(cart[index].colorselection!.price! - (cart[index].colorselection!.price! * (double.parse(cart[index].product!.discount.toString()) / 100))).toStringAsFixed(2)}',
                                            style: TextStyle(
                                                fontSize: 18.9,
                                                fontWeight: FontWeight.w500,
                                                color: Color(
                          ...
                          child: Column(
                            children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      "Payment status",
                                      style: TextStyle(
                                          color: Colors.grey, fontSize: 12.8),
                                    ),
                                    Text(
                                        ' ${state?.orderDetail?.ispaid == false ? 'Not Paid' : 'Paid'}'),
                                  ],
                                ),
                              ),
                              Container(
                              ...
                              Container(
                                ...
                                decoration:
                                    BoxDecoration(color: Color.fromRGBO(112, 16, 223, 100)
                                .withOpacity(0.4),
                                ),
                                child: Row(
                                  mainAxisAlignment:
