...
class _GoogleMapScreenState extends State<GoogleMapScreen> {
  ...
  SendLatandLong(lat, long) async {
    ...
    setState(() {
      ...
      // handle map mockup address data
      homeadd = 'Street 2BZ, Phnom Penh';
      country = 'Cambodia';
      city = 'Phnom Penh';
            ...
            Expanded(
              child: TextField(
                ...
                onSubmitted: (value) async {
                  ...
                  print(placeid);
                  var map = await locationhelper.getPlaceDetail(placeid)
                  ...
                  setState(() {
                    ...
                    mapController?.animateCamera(CameraUpdate.newCameraPosition(
                        CameraPosition(
                            target:
                                LatLng(widget.positionlat, widget.positionlong),
                            zoom: 17)));
                  });
                },
            ...
            Expanded(
              child: GoogleMap(
                ...
                initialCameraPosition: CameraPosition(
                  target:
                      LatLng(widget.positionlat ?? 0, widget.positionlong ?? 0),
                  zoom: 17,
                ),
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              txtdesc.text = value;
                              txtdesc.selection = TextSelection.fromPosition(
                                  TextPosition(offset: txtdesc.text.length));
                            });
                          },
                          validator: (value) {
                            if (value.toString().length == 0 ||
